...
return [
    ...
    | lớp trình xác thực. Một số quy tắc có nhiều phiên bản như các quy tắc kích thước.
    | Hãy thoải mái điều chỉnh từng thông báo tại đây.
    |
    */
    ...
    'between' => [
        ...
        'file' => 'Trường :attribute phải có từ :min đến :max kilobyte.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Trường :attribute đã bị rò rỉ dữ liệu. Vui lòng chọn một :attribute khác.',
    ],
    ...
    | giúp nhanh chóng chỉ định một thông báo tùy chỉnh cụ thể cho quy tắc thuộc tính nhất định.
    |
    */
    ...
    | bằng thứ gì đó thân thiện hơn với người đọc chẳng hạn như "Địa chỉ E-Mail"
    | thay vì "email". Điều này đơn giản giúp chúng tôi làm cho thông báo của mình dễ hiểu hơn.
    |
    */
