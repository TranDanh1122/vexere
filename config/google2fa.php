...
return [
     ...
     */
    'error_messages' => [
        'wrong_otp'       => "AdminUser::admin.error_messages.wrong_otp",
        'cannot_be_empty' => 'AdminUser::admin.error_messages.cannot_be_empty',
        'unknown'         => 'AdminUser::admin.error_messages.unknown',
    ],
