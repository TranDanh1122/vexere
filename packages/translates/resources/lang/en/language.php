...
return [
    ...
    'status' => 'Status',
    'toggle_active' => 'Toggle active :language',
    ...
    'default_language_helper' => 'All data, website content, and user interfaces will be displayed in this language.<br/> When users visit the website, they will see content in the default language.',
    'timezone' => 'Timezone',
    'multiple_language' => 'Turn On/Off multiple languages',
    'language_search' => 'Multi-language',
    'config' => 'Settings',
    'show_pannel_language' => 'Admin panel language',
    'show_pannel_language_helper' => 'This is the language used for the website\'s admin interface.<br/> It only affects how text is displayed in the content management panel for administrators.<br/> Administrators can choose this language to work with the admin interface more easily, but it does not affect the content displayed for end users on the website.',
];
