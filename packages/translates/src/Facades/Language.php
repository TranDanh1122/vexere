...
namespace DreamTeam\Translate\Facades;
 ...
 * @method static string|null getAminpannelLocale()
 * @method static bool isHasMultipleLanguage()
 * @method static string getTimezone()
 * @method static array setLanguageToConfig()
 ...
 * @method static \DreamTeam\Translate\Models\Language|\DreamTeam\Base\Models\BaseModel|\Illuminate\Database\Eloquent\Model|null getDefaultLanguage(array $select = ['*'])
 ...
 * @method static \DreamTeam\Translate\LanguageManager registerModule(array|string $model)
 ...
 * @method static \DreamTeam\Translate\LanguageManager setSwitcherURLs(array $urls)
 ...
 * @method static array getAllLang()
 * @method static array getAllNameSpace()
 * @method static formatGroupLang(string $group)
 * @method static formatKeyLang(array $item)
 * @method static formatValueLang(array $item)
 * @method static void updateTranslation(string $locale, string $group, string $key, string|null $value)
 * @method static int createLocaleInPath(string $path, string $locale)
 *
 * @see \DreamTeam\Translate\LanguageManager
 */
