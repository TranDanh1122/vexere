...
use DreamTeam\Base\Helpers\BaseHelper as BaseHelperSupport;
 ...
 * @method static \DreamTeam\Base\Helpers\BaseHelper iniSet(string $key, string|int|null $value)
 * @method static \DreamTeam\Base\Helpers\BaseHelper maximumExecutionTimeAndMemoryLimit()
 ...
 * @method static string|null getCurrentPageName()
 * @method static mixed googleFonts(string $font, bool $inline = true)
 * @method static string joinPaths(array $paths)
 * @method static array injectionBreadcrumbSetting(array $breabcrumbs)
 *
 * @see \DreamTeam\Base\Helpers\BaseHelper
 */
