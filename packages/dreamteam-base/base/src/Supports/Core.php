...
use DreamTeam\Base\Events\UpdatedEvent;
use DreamTeam\Base\Events\UpdatingEvent;
use DreamTeam\PluginManagement\Services\PluginService;
use DreamTeam\Theme\Services\ThemeService;
use Exception;
...
use DreamTeam\Menu\Facades\Menu;
use DreamTeam\Theme\Facades\Theme;
use Throwable;
use ZipArchive;
...
final class Core
{
    ...
    {
        $this->apiUrl = 'https://license.DreamTeam.com';
    ...
    public function processUpdate(string $destination): void
    {
        ...
        try {
            ...
            File::delete(theme_path(Theme::getThemeName() . '/public/css/style.integration_desktop.css'));
            File::delete(theme_path(Theme::getThemeName() . '/public/css/style.integration_mobile.css'));
            ...
            if (File::exists($customCSS)) {
                ...
                File::copy($customCSS, storage_path('app/style.integration_desktop.css.') . time());
                File::copy($customCSS, storage_path('app/style.integration_mobile.css.') . time());
