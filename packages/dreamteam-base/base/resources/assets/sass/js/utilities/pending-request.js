...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => DreamTeamCore.showButtonLoading(element))
        this.completed(() => DreamTeamCore.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => DreamTeamCore.showLoading(element))
        this.completed(() => DreamTeamCore.hideLoading(element))
    ...
    withDefaultErrorHandler() {
        this.errorHandlerUsing((error) => {
            ...
            switch (statusCode) {
                case 419:
                    DreamTeamCore.showError('Session expired this page will reload in 5s.')
                ...
                default:
                    if (data.message !== undefined) {
                        DreamTeamCore.showError(data.message)
                    }
            }
