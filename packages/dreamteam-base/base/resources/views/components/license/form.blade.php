<x-Core::alert type="warning">
    @if ($manageLicense = auth()->guard('admin')->user()->hasPermission('core.manage.license'))
...
<x-core-setting::form-group>
    ...
    <div class="form-hint">
        <a
            href="{{ $licenseURL = \DreamTeam\Base\Supports\Core::make()->getLicenseUrl() }}"
            target="_blank"
...
<div>
    ...
    <p>
        ...
        Purchase a
        <a
            href="{{ \DreamTeam\Base\Supports\Core::make()->getLicenseUrl('/buy') }}"
            target="_blank"
            rel="nofollow"
        >
            new license here
