...
<head>
    ...
    <meta
        name="description"
        content="{{ $copyright = strip_tags(trans('Core::layouts.copyright', ['year' => Carbon\Carbon::now()->year, 'company' => setting('admin_title', config('core.base.general.base_name')), 'version' => get_cms_version()])) }}"
    >
    <meta
    ...
    @include('Core::components.layouts.header')
...
<body
    ...
    {!! \DreamTeam\Base\Facades\Html::attributes($bodyAttributes ?? []) !!}
